...
const PinDetail = ({ user }) => {
  ...
  const fetchPinDetails = () => {
    ...
    setTimeout(() => {
      ...
      if(details[0]){
        let similiar = POSTS.filter((post) => post.catagory === details[0].catagory && post._id.toString() !== pinId)
        setPins(similiar)
      }  
    }, 1000);
  }
      ...
      <div className='flex xl-flex-row flex-col m-auto bg-white' style={{maxWidth: '1500px', borderRadius: '32px'}}>
        ...
        <div className='w-full flex-1 xl:min-w-620 pl-3'>
          <div className='flex items-center justify-between'>
            ...
            <a href={pinDetail.destination} target="_blank" rel='noreferrer' className='pr-3'>
          ...
          >
            <img 
              ...
              alt="user-profile"
            />
            <p className='font-semibold capitalize p-2'>{pinDetail.postedBy.userName}</p>
          </Link>
